...
parser.add_argument('--output-dir', default='data/model/', help='Data directory (default: data/model/)', dest='output_dir')
...
parser.add_argument('--num-layers', default=32, type=int, help='Number of input layers (default: 32)', dest='num_input_layers')
...
parser.add_argument('--filter-count', nargs='+', default=10, type=int, help='Number of convolutions layers  (default: 10)', dest='filter_count')
...
data_set = input_data.read_data_sets(args.data_file, args.num_input_layers)
