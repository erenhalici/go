...
next_moves = tf.nn.top_k(filtered, K)

saver = tf.train.Saver()

sess1 = tf.Session()
sess1.run(tf.initialize_all_variables())
# saver.restore(sess1, "data/models/old/model_93000_00874.ckpt")
# saver.restore(sess1, "data/models/old/model_159000_01715.ckpt")
# saver.restore(sess1, "data/models/old/model_446000_02135.ckpt")
saver.restore(sess1, "data/models/old/model_593000_0219.ckpt")
# saver.restore(sess1, "data/models/old/model.ckpt")

sess2 = tf.Session()
sess2.run(tf.initialize_all_variables())
# saver.restore(sess2, "data/models/old/model_93000_00874.ckpt")
# saver.restore(sess2, "data/models/old/model_159000_01715.ckpt")
# saver.restore(sess2, "data/models/old/model_446000_02135.ckpt")
saver.restore(sess2, "data/models/old/model_593000_0219.ckpt")
# saver.restore(sess2, "data/models/old/model.ckpt")
